...
var LedgerHelper = /** @class */ (function () {
    function LedgerHelper(persistenceService) {
        ...
        this.loginUrl = 'http://testnet-uk.activeledger.io:5555/login';
        this.registerUrl = 'http://testnet-uk.activeledger.io:5555/register';
        this.createProfileUrl = 'http://testnet-uk.activeledger.io:5555/transaction/createProfile';
        this.addReportURL = 'http://testnet-uk.activeledger.io:5555/transaction';
        this.updateProfileUrl = 'http://testnet-uk.activeledger.io:5555/transaction';
        this.updateReportURL = 'http://testnet-uk.activeledger.io:5555/transaction';
    ...
    Object.defineProperty(LedgerHelper.prototype, "key", {
        get: function () {
            return JSON.parse(localStorage.getItem('key:' + this.email));
        },
        set: function (key) {
            localStorage.setItem('key:' + this.email, JSON.stringify(key));
        },
        enumerable: true,
        configurable: true
    });
    LedgerHelper.prototype.sanitizeDP = function (dp) {
        var to_remove = 'data:image/jpeg;base64,';
        var to_remove2 = 'SafeValue must use [property]=binding:';
        var to_remove3 = ' (see http://g.co/ng/security#xss)';
        return dp.replace(to_remove, '').replace(to_remove2, '').replace(to_remove3, '');
    };
    Object.defineProperty(LedgerHelper.prototype, "token", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper.prototype, "address", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper.prototype, "date_of_birth", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper.prototype, "dp", {
        get: function () {
            return this.sanitizeDP(localStorage.getItem('dp'));
        },
        set: function (dp) {
            localStorage.setItem('dp', this.sanitizeDP(dp));
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(LedgerHelper.prototype, "email", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper.prototype, "first_name", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper.prototype, "last_name", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper.prototype, "full_name", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper.prototype, "gender", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper.prototype, "phone_number", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper.prototype, "profile_type", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper.prototype, "resecurityports", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper.prototype, "security", {
    ...
    Object.defineProperty(LedgerHelper.prototype, "_id", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper.prototype, "profileCreated", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper.prototype, "isLoggedin", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper.prototype, "report", {
        get: function () {
    ...
    Object.defineProperty(LedgerHelper.prototype, "reports", {
        get: function () {
            // return this.persistenceService.get('reportlist', StorageType.SESSION);
            return this.persistenceService.get('reportlist');
        },
        set: function (reports) {
            this.persistenceService.set('reportlist', reports);
