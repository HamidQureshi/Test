(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~add-report-page-add-report-module~create-profile-create-profile-module~layout-layout-module~~00c490c7"],{
...
/* harmony import */ var _helper_ledgerhelper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../helper/ledgerhelper */ "./src/app/helper/ledgerhelper.ts");
...
var LayoutComponent = /** @class */ (function () {
    function LayoutComponent(ledgerHelper, http, snackBar) {
        ...
        this.getPatient(headers)
            ...
            if (data.status === 200) {
                ...
                if (data.body.streams.length <= 0) {
                    var message = 'No patients assigned';
                    _this.showSnackBar(message);
                    return;
                }
                var index = 1;
                for (var i = 0; i < data.body.streams.length; i++) {
                    ...
                    for (var j = 0; j < data.body.streams[i].reports.length; j++) {
                        var report = {
                            id: '' + (index++),
    ...
    LayoutComponent.prototype.getReportList = function (headers) {
        ...
        this.getReport(headers).subscribe(function (data) {
            ...
            if (data.status === 200) {
                ...
                // this.open();
                if (data.body.streams.length <= 0) {
                    var message = 'No reports found in ledger';
                    _this.showSnackBar(message);
                    return;
                }
    ...
    LayoutComponent.prototype.showSnackBar = function (message) {
    ...
    LayoutComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_helper_ledgerhelper__WEBPACK_IMPORTED_MODULE_2__["LedgerHelper"], _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatSnackBar"]])
    ], LayoutComponent);
...
//# sourceMappingURL=default~add-report-page-add-report-module~create-profile-create-profile-module~layout-layout-module~~00c490c7.js.map